...
enum categoryInverse {
  ...
  "Arcade et Jeu" = "arcade-game",
  "Audiovisuel & Hi-Fi" = "audiovisual-hifi",
  "Chaises et Fauteuils" = "chairs",
  "Chambre à coucher" = "bedroom",
  "Cuisine" = "kitchen",
  "Décoration Murale" = "wall-decor",
  "Décoration" = "decoration",
  "Divers" = "divers",
  "Drapeau et Logo" = "flag-logo",
  "Éclairages" = "lighting",
  "Figurine et Statue" = "figurine-statue",
  "Informatique et Bureautique" = "computer-office",
  "Nourriture & Boissons" = "food-drinks",
  "Salle de bains" = "bathroom",
  "Fitness & Sport" = "fitness-sport",
  "Tables et Bureaux" = "tables-desks",
  "Tapis" = "carpets",
